...
export default {
  ...
  com_ui_misc: 'Project A',
  com_ui_roleplay: 'Project B',
  com_ui_write: 'Product Manager',
  com_ui_idea: 'My daily Tasks',
  com_ui_shop: 'Customer Success Manager',
  com_ui_finance: 'Project C',
  com_ui_code: 'Web Developer',
  com_ui_travel: 'Market Researcher',
  com_ui_teach_or_explain: 'Social Media Manager',
